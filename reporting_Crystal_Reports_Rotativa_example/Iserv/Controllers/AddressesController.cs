...
namespace Iserv.Controllers
{
    public class AddressesController : Controller
    {
        ...
        {
            var addresses = db.Addresses.Include(a => a.City).Include(a => a.Province);
        ...
        public async Task<ActionResult> Create([Bind(Include = "AddressID,StreetNumber,StreetName,CityID,ProvinceID,ConsumerID")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "AddressID,StreetNumber,StreetName,CityID,ProvinceID,ConsumerID")] Address address)
        {
            if (ModelState.IsValid)
            {
